...
type PokerFinalPolishPanelProps = {
    polish?: {
        phase?: string | number | null;
        title?: string | null;
        summary?: string | null;
        checklist?: PolishChecklistItem[] | null;
        nextPhase?: {
            phase?: string | number | null;
            title?: string | null;
            note?: string | null;
...
export default function PokerFinalPolishPanel({ polish = null }: PokerFinalPolishPanelProps) {
