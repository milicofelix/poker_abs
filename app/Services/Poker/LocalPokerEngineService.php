...
final class LocalPokerEngineService
{
     ...
     */
    public function play(array $currentState, string $action, int $raiseAmount = 0): array
    {
        ...
        $dealerPosition = $roundState->dealerPosition;
        ...
        if ($pokerAction === PokerAction::Raise) {
            ...
            $maximumTargetBet = $playerStreetBet + $playerStack;
